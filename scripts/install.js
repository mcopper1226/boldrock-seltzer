...
const title = WP_TITLE || 'Bold Rock Hard Cider';
const user = WP_ADMIN_USER || 'adm1n-mc';
const email = WP_ADMIN_EMAIL || 'megancopper1@gmail.com';
const theme = WP_THEME_NAME || 'boldrock-wp';
