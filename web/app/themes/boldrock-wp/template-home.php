      ...
      <div class="inner-container">
        ...
        <ul class="social-links">
          <li class="social_link">
            <a href="https://www.facebook.com/boldrockhardseltzer/" target="_blank"><svg id="facebook" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="social_link">
            <a href="https://www.instagram.com/boldrockhardseltzer/" target="_blank"><svg viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              <g id="instagram">
